...
const CLASS_RULES = [
  ...
  { questionClass: 'employee_referral', re: /current\w* (a |an )?\w*\s*employee|employee of|previously (been )?employed|former employee|(referred|referral).*\b(name|contact|who)\b/ },
...
module.exports = { classifyQuestion, guardAnswer, normalize };
