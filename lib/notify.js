 ...
 */
async function sendSessionSummary({ sessionId, durationMin, scanned, applied, alreadyApplied = 0, skipped, failed, dsCalls, topFail, weekApplied, weekTarget, dbTotal, dryRun }, logger) {
